...
# a simple script for the evaluation of the Reactor Benchmark for a given event generation rate in the stream-bench.sh file
set -o errexit -o nounset

export PLATFORM=$1
export LOAD=$2

# Be in the directory: ~/github/ysb-reactor
...
case "$PLATFORM" in 
	...
	native) target/graalvm-native-image/ysb-reactor &
	export YSB_RUN_PID=$!
