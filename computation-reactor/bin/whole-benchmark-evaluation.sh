...
# a simple script for the evaluation of the Reactor Benchmark
...
export projectDir=~/github/computation-reactor
...
case "$PLATFORM" in 
	...
	native) target/graalvm-native-image/computation-reactor > Benchmark_Results/$PLATFORM-latencies.txt &
	export RUN_PID=$!
